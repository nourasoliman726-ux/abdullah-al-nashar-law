...
import { CheckCircle2, Paperclip, AlertCircle } from "lucide-react";
...
export default function BookConsultationPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const fileUrl = await uploadAttachment(form.file, "consultation-requests");
      ...
      console.error(err);
      setError("حدث خطأ أثناء إرسال الطلب. حاول مرة أخرى أو تواصل عبر واتساب مباشرة.");
    } finally {
      setLoading(false);
    }
  }
